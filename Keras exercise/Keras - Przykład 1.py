...
model.add(Dense(num_pixels/4, input_dim=num_pixels/2, kernel_initializer='normal', activation='relu'))

model.add(Dense(num_pixels/8, input_dim=num_pixels/4, kernel_initializer='normal', activation='relu'))

model.add(Dense(num_pixels/16, input_dim=num_pixels/8, kernel_initializer='normal', activation='relu'))
